...
<head>
    ...
    <!-- Icons -->
    <?php include($_SERVER['DOCUMENT_ROOT']."/fand/included/icon.php"); ?>
...
<body>
    ...
    <main>
        <section class="main">
            <?php include($_SERVER['DOCUMENT_ROOT']."/fand/included/included.php"); ?>
            <div class="content">
                <div class="form">
                    <div class="welcome">
                        <h1>Registro</h1>
    ...
    <script type="x-shader/x-vertex" id="vertexShader">
        ...
        void main() {
            ...
            newPosition = newPosition + 0.1*normal*snoise(vec4(normal * u_clickEvent, u_time));
    ...
    <script type="x-shader/x-fragment" id="fragmentShader">
        ...
        void main()
        {
            gl_FragColor = vec4(0.42, 0.47, 0.41, 1.);
        }
    </script>
